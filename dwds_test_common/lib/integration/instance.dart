...
void runTests({
  ...
  group(
    ...
    () {
      ...
      Future<RemoteObject> getMapRef() =>
          inspector.invoke(libraryUri, 'getMap');
      ...
      group('instanceRef', () {
        ...
        test('for a double', () async {
          ...
          // 'count' is incremented by a periodic timer in the application, so
          // we can't expect it to be exactly 0.
