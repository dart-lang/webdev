...
/// generated, for example the file `foo/bar/baz.dart` will generate a property
/// named approximately `foo__bar__baz`. Rather than attempt to guess, we assume
/// the first property of this object is the module.
