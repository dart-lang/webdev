    ...
    group('Injected client with DevTools served from '
      ...
      test(
        ...
        () async {
          ...
          // Wait for the page to be ready before trying to open
          // DevTools again.
      ...
      test(
        ...
        () async {
          // This test is the same as one in reload_test, but runs here
          // when there is a connected client (DevTools) since it can
          // behave differently.
