...
void main() {
  ...
  group('shared chrome instance', () {
    ...
    test('evaluate', () {
      expect(
          () => service.evaluate(null, null, null), throwsUnimplementedError);
    });
    ...
    test('registerService', () {
      expect(
          () => service.registerService(null, null), throwsUnimplementedError);
    });
    ...
    group('streamListen/onEvent', () {
      ...
      test('Extension', () async {
        expect(
            () => service.streamListen('Extension'), throwsUnimplementedError);
      });

      test('Timeline', () async {
        expect(
            () => service.streamListen('Timeline'), throwsUnimplementedError);
      });
    });
  });

  group('isolated chrome instance', () {
    group('streamListen/onEvent', () {
      Chrome chrome;
      ChromeProxyService service;
