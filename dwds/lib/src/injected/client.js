// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.4.0-47.0.dev.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    SplayTreeSet$(compare, $E) {
      return new A.SplayTreeSet(compare, new A.SplayTreeSet_closure($E), $E._eval$1("SplayTreeSet<0>"));
    },
    ...
    FutureOfVoidToJSPromise_get_toJS(_this) {
      return A.callConstructor(self.Promise, [type$.JavaScriptFunction._as(A.allowInterop(new A.FutureOfVoidToJSPromise_get_toJS_closure(_this), type$.Function))], type$.JSObject);
    },
    ...
    Serializers_Serializers() {
      ...
      t2.add$1(0, new A.Int32Serializer(A.BuiltList_BuiltList$from([B.Type_Int32_Mhf], t1)));
    ...
    _$ConnectRequest: function _$ConnectRequest(t0, t1, t2, t3) {
      var _ = this;
      _.appName = t0;
      _.appId = t1;
      _.instanceId = t2;
    ...
    ConnectRequestBuilder: function ConnectRequestBuilder() {
      var _ = this;
      _._entrypoints = _._instanceId = _._connect_request$_appId = _._appName = _._connect_request$_$v = null;
    },
    ...
    DebugEventBuilder: function DebugEventBuilder() {
      var _ = this;
      _._debug_event$_timestamp = _._debug_event$_eventData = _._debug_event$_kind = _._debug_event$_$v = null;
    },
    ...
    DebugInfoBuilder: function DebugInfoBuilder() {
      var _ = this;
      _._tabId = _._tabUrl = _._workspaceName = _._isFlutterApp = _._isInternalBuild = _._extensionUrl = _._dwdsVersion = _._authUrl = _._appUrl = _._appOrigin = _._appInstanceId = _._appId = _._appEntrypointPath = _._debug_info$_$v = null;
    },
    ...
    RegisterEntrypointRequest: function RegisterEntrypointRequest() {
    },
    _$RegisterEntrypointRequestSerializer: function _$RegisterEntrypointRequestSerializer() {
    },
    _$RegisterEntrypointRequest: function _$RegisterEntrypointRequest(t0, t1) {
      this.appName = t0;
      this.entrypointPath = t1;
    },
    RegisterEntrypointRequestBuilder: function RegisterEntrypointRequestBuilder() {
      this._entrypointPath = this._register_entrypoint_request$_appName = this._register_entrypoint_request$_$v = null;
    },
    ...
    RegisterEventBuilder: function RegisterEventBuilder() {
      this._timestamp = this._eventData = this._$v = null;
    },
    ...
    _$serializers_closure1: function _$serializers_closure1() {
    },
      ...
      $label0$0:
        for (t2 = lastVisited.$ti._precomputed1, t3 = $T._eval$1("JSArray<0>"), index = 0; t5 = t1.length, t5 !== 0;) {
          ...
          if (iterator == null) {
            ...
            t6.toString;
            lowLink = Math.min(A.checkNum(t5), A.checkNum(t6));
          }
          do {
            ...
            if (!indexes.containsKey$1(next)) {
              ...
              t5.toString;
              lowLink = Math.min(lowLink, A.checkNum(t5));
          ...
          if (lowLink === indexes.$index(0, node)) {
            ...
            } while (!A.boolConversionCheck(A._defaultEquals(result0, node)));
    ...
    HttpRequest_request(url, method, responseType, withCredentials) {
      ...
      t3 = type$.nullable_void_Function_JavaScriptObject;
      A._EventStreamSubscription$(xhr, "load", t3._as(new A.HttpRequest_request_closure(xhr, completer)), false, t2);
      A._EventStreamSubscription$(xhr, "error", t3._as(completer.get$completeError()), false, t2);
      xhr.send();
      return t1;
    },
    ...
    HtmlWebSocketChannel$connect(url, protocols) {
      ...
      t1 = A.callConstructor(t2, [t3, t1], t4);
    ...
    runClient() {
      var $async$goto = 0,
        ...
        t3, t4, t5, t6, t7, t8, t9, t10, dwdsConnection, uri, fixedPath, fixedUri, _0_0, manager, t1, t2, appInfo;
      var $async$runClient = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = self;
              t2 = type$.JavaScriptObject;
              appInfo = t2._as(t1.$dartAppInfo);
              appInfo.appInstanceId = B.C_Uuid.v1$0();
              t1.$dartAppInstanceId = A._asString(appInfo.appInstanceId);
              t1.$dartAppId = A._asString(appInfo.appId);
              t3 = type$.JavaScriptFunction;
              t1.$loadModuleConfig = t3._as(appInfo.loadModuleConfig);
              t4 = A._asString(appInfo.devHandlerPath);
              t5 = $.Zone__current;
              t6 = Math.max(100, 1);
              t7 = A.StreamController_StreamController(null, null, false, type$.DebugEvent);
              t8 = A.StreamController_StreamController(null, null, false, type$.List_DebugEvent);
              t5 = new A.BatchedStreamController(t6, 1000, t7, t8, new A._AsyncCompleter(new A._Future(t5, type$._Future_bool), type$._AsyncCompleter_bool), type$.BatchedStreamController_DebugEvent);
              t6 = A.List_List$filled(A.QueueList__computeInitialCapacity(null), null, false, type$.nullable_Result_DebugEvent);
              t9 = A.ListQueue$(type$._EventRequest_dynamic);
              t10 = type$.StreamQueue_DebugEvent;
              t5.set$__BatchedStreamController__inputQueue_A(t10._as(new A.StreamQueue(new A._ControllerStream(t7, A._instanceType(t7)._eval$1("_ControllerStream<1>")), new A.QueueList(t6, 0, 0, type$.QueueList_Result_DebugEvent), t9, t10)));
              A.safeUnawaited(t5._batchAndSendEvents$0());
              dwdsConnection = new A.DevHandlerConnection(t5);
              uri = A.Uri_parse(t4);
              ...
              t4 = fixedUri.isScheme$1("ws") || fixedUri.isScheme$1("wss") ? new A.WebSocketClient(A.HtmlWebSocketChannel$connect(fixedUri, null)) : new A.SseSocketClient(A.SseClient$(fixedPath, "InjectedClient"));
              dwdsConnection.__DevHandlerConnection_client_F = t4;
              new A._ControllerStream(t8, A._instanceType(t8)._eval$1("_ControllerStream<1>")).listen$1(dwdsConnection.get$_sendBatchedDebugEvents());
              t8 = type$.Function;
              t1.$dartRegisterEntrypoint = t3._as(A.allowInterop(new A.runClient_closure(appInfo, dwdsConnection), t8));
              A.print("Injected Client " + A.S(A._asStringQ(t1.$dartAppInstanceId)) + ": set registerEntrypoint");
              _0_0 = A._asString(appInfo.moduleStrategy);
              $async$goto = "require-js" === _0_0 ? 3 : 4;
              break;
            case 3:
              // then
              $async$goto = 5;
              return A._asyncAwait(A.RequireRestarter_create(), $async$runClient);
            case 5:
            ...
            case 4:
              // join
              if ("legacy" === _0_0) {
                t5 = new A.LegacyRestarter();
                // goto break $label0$0
                $async$goto = 2;
                break;
              }
              t5 = A.throwExpression(A.StateError$("Unknown module strategy: " + A.S(A.getProperty(appInfo, "moduleStrategy", type$.String))));
            case 2:
              // break $label0$0
              manager = new A.ReloadingManager(t4, t5);
              t1.$dartHotRestartDwds = t3._as(A.allowInterop(new A.runClient_closure0(manager), t8));
              t1.$emitDebugEvent = t3._as(A.allowInterop(new A.runClient_closure1(appInfo, dwdsConnection), t8));
              t1.$emitRegisterEvent = t3._as(A.allowInterop(dwdsConnection.get$sendRegisterEvent(), t8));
              t1.$launchDevTools = t3._as(A.allowInterop(new A.runClient_closure2(dwdsConnection, appInfo), t8));
              t4.get$stream().listen$2$onError(new A.runClient_closure3(appInfo, manager), new A.runClient_closure4());
              if (A._asBool(appInfo.enableDevToolsLaunch))
                A._EventStreamSubscription$(t2._as(t1.window), "keydown", type$.nullable_void_Function_JavaScriptObject._as(new A.runClient_closure5()), false, t2);
              if (A._isChromium()) {
                t1 = A._asString(appInfo.appName);
                t2 = A._asString(appInfo.appId);
                t3 = A._asString(appInfo.appInstanceId);
                t4 = A.JSArrayExtension_toDartIterable(type$.JSArray_nullable_Object._as(appInfo.entrypoints), type$.String);
                dwdsConnection.sendConnectRequest$4(t1, t2, t3, A.List_List$of(t4, true, t4.$ti._eval$1("ListIterable.E")));
              } else
                A.runMain();
              new A.DebugExtensionConnection(appInfo).launchCommunication$0();
              // implicit return
              return A._asyncReturn(null, $async$completer);
          }
      });
      return A._asyncStartSync($async$runClient, $async$completer);
    },
    DebugExtensionConnection__authenticateUser(authUrl) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$temp1, $async$temp2;
      var $async$DebugExtensionConnection__authenticateUser = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = A;
              $async$goto = 3;
              return A._asyncAwait(A.HttpRequest_request(authUrl, "GET", null, true), $async$DebugExtensionConnection__authenticateUser);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1.contains$1($async$temp2._asString($async$result.responseText), "Dart Debug Authentication Success!");
              // goto return
              $async$goto = 1;
              break;
            case 1:
      ...
      return A._asyncStartSync($async$DebugExtensionConnection__authenticateUser, $async$completer);
    },
    _isChromium() {
    ...
    runClient_closure: function runClient_closure(t0, t1) {
      this.appInfo = t0;
      this.dwdsConnection = t1;
    },
    runClient_closure0: function runClient_closure0(t0) {
      this.manager = t0;
    },
    runClient_closure1: function runClient_closure1(t0, t1) {
      this.appInfo = t0;
      this.dwdsConnection = t1;
    },
    runClient_closure2: function runClient_closure2(t0, t1) {
      this.dwdsConnection = t0;
      this.appInfo = t1;
    },
    runClient_closure3: function runClient_closure3(t0, t1) {
      this.appInfo = t0;
      this.manager = t1;
    },
    runClient_closure4: function runClient_closure4() {
    },
    runClient_closure5: function runClient_closure5() {
    },
    DebugExtensionConnection: function DebugExtensionConnection(t0) {
      this.appInfo = t0;
    },
    DebugExtensionConnection_launchCommunication_closure: function DebugExtensionConnection_launchCommunication_closure(t0) {
      this.$this = t0;
    },
    DebugExtensionConnection__handleAuthRequest_closure: function DebugExtensionConnection__handleAuthRequest_closure(t0) {
      this.$this = t0;
    },
    DevHandlerConnection: function DevHandlerConnection(t0) {
      this.__DevHandlerConnection_client_F = $;
      this.debugEventController = t0;
    },
    DevHandlerConnection_sendConnectRequest_closure: function DevHandlerConnection_sendConnectRequest_closure(t0, t1, t2, t3) {
      var _ = this;
      _.appName = t0;
      _.appId = t1;
      _.appInstanceId = t2;
    ...
    DevHandlerConnection_sendRegisterEntrypointRequest_closure: function DevHandlerConnection_sendRegisterEntrypointRequest_closure(t0, t1) {
      this.appName = t0;
      this.entrypointPath = t1;
    },
    DevHandlerConnection__sendBatchedDebugEvents_closure: function DevHandlerConnection__sendBatchedDebugEvents_closure(t0) {
      this.events = t0;
    },
    DevHandlerConnection_sendDebugEvent_closure: function DevHandlerConnection_sendDebugEvent_closure(t0, t1) {
      this.kind = t0;
      this.eventData = t1;
    },
    DevHandlerConnection_sendRegisterEvent_closure: function DevHandlerConnection_sendRegisterEvent_closure(t0) {
      this.eventData = t0;
    },
    DevHandlerConnection_sendDevToolsRequest_closure: function DevHandlerConnection_sendDevToolsRequest_closure(t0, t1) {
      this.appId = t0;
      this.appInstanceId = t1;
    },
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              reloader.set$__RequireRestarter__dirtyModules_A(type$.SplayTreeSet_String._as(A.SplayTreeSet$(reloader.get$_moduleTopologicalCompare(), t1)));
              $async$goto = 3;
    ...
    _findNonce() {
      ...
      for (t2 = type$.nullable_JavaScriptObject, i = 0; i < A._asInt(elements.length); ++i) {
    ...
    runMain() {
      var t3,
        t1 = self,
        t2 = type$.JavaScriptObject,
        scriptElement = t2._as(t2._as(t1.document).createElement("script")),
        nonce = A._findNonce();
      if (nonce != null)
        scriptElement.setAttribute("nonce", nonce);
      scriptElement.innerHTML = "window.$dartRunMain();";
      t1 = type$.nullable_JavaScriptObject._as(t2._as(t1.document).body);
      t1.toString;
      t2 = A.jsify(scriptElement);
      t2.toString;
      t3 = type$.void;
      A.callMethod(t1, "append", [t2], t3);
      A.Future_Future$microtask(new A.runMain_closure(scriptElement), t3);
    },
    ...
    ModuleDependencyGraph_parents(_this, key) {
      var t1 = A.callMethod(_this, "get", [key], type$.nullable_JSArray_nullable_Object);
      if (t1 == null)
        t1 = null;
      else {
  ...
  A._Uri.prototype = {
    ...
    replace$2$path$scheme(path, scheme) {
      ...
      t1 = path == null;
      if (!t1 || false)
        path = A._Uri__makePath(path, 0, t1 ? 0 : path.length, null, scheme, hasAuthority);
      else {
  ...
  A._SimpleUri.prototype = {
    ...
    replace$2$path$scheme(path, scheme) {
      ...
      t1 = path == null;
      if (!t1 || false)
        path = A._Uri__makePath(path, 0, t1 ? 0 : path.length, _null, scheme, hasAuthority);
      else {
  ...
  A.FutureOfVoidToJSPromise_get_toJS__closure.prototype = {
    call$1(_) {
      var t1 = this.resolve;
      return A.callMethod(t1, "call", [t1], type$.nullable_Object);
    },
    $signature: 31
  };
  A.FutureOfVoidToJSPromise_get_toJS__closure0.prototype = {
    call$2(error, stackTrace) {
      ...
      t2 = this.reject;
      A.callMethod(t2, "call", [t2, t1], type$.nullable_Object);
    },
    $signature: 5
  };
  ...
  A.StreamQueue.prototype = {
    ...
    _addResult$1(result) {
      ...
      t1._queue_list$_add$1(t1.$ti._precomputed1._as(result));
  ...
  A._NextRequest.prototype = {
    update$2(events, isDone) {
      ...
      if (!events.get$isEmpty(events)) {
        ...
        t2 = events._queue_list$_table;
        if (!(t1 < t2.length))
          return A.ioore(t2, t1);
        result = t2[t1];
        if (result == null)
          result = events.$ti._precomputed1._as(result);
        B.JSArray_methods.$indexSet(t2, t1, null);
        events._queue_list$_head = (events._queue_list$_head + 1 & events._queue_list$_table.length - 1) >>> 0;
  ...
  A.BuiltSet.prototype = {
    ...
    contains$1(_, element) {
      return this._set.contains$1(0, element);
    },
    get$isEmpty(_) {
      return this._set._collection$_length === 0;
    },
    get$isNotEmpty(_) {
      return this._set._collection$_length !== 0;
    },
    ...
    get$first(_) {
      return this._set.get$first(0);
    },
    elementAt$1(_, index) {
      return this._set.elementAt$1(0, index);
    },
    $isIterable: 1
  };
    ...
    build$0() {
      ...
      if (_this._builtMapOwner == null) {
        ...
        for (; t1.moveNext$0();) {
          ...
          t2 = builtSet._set._collection$_length;
    ...
    _getValuesBuilder$1(key) {
      ...
      if (result == null) {
        ...
        if (builtValues == null)
          ...
          result = new A.SetBuilder(builtValues._setFactory, builtValues._set, builtValues, t1._eval$1("SetBuilder<1>"));
        }
  ...
  A._$ConnectRequestSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      return ["appName", serializers.serialize$2$specifiedType(object.appName, B.FullType_h8g), "appId", serializers.serialize$2$specifiedType(object.appId, B.FullType_h8g), "instanceId", serializers.serialize$2$specifiedType(object.instanceId, B.FullType_h8g), "entrypoints", serializers.serialize$2$specifiedType(object.entrypoints, B.FullType_hkZ)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
    deserialize$3$specifiedType(serializers, serialized, specifiedType) {
      var t1, t2, t3, t4, t5, value, t6, t7, t8, t9,
        result = new A.ConnectRequestBuilder(),
        iterator = J.get$iterator$ax(type$.Iterable_nullable_Object._as(serialized));
      for (t1 = type$.BuiltList_nullable_Object, t2 = type$.String, t3 = type$.List_String, t4 = type$.ListBuilder_String; iterator.moveNext$0();) {
        ...
        switch (t5) {
          case "appName":
            t5 = serializers.deserialize$2$specifiedType(value, B.FullType_h8g);
            t5.toString;
            A._asString(t5);
            result.get$_connect_request$_$this()._appName = t5;
            break;
          case "appId":
            t5 = serializers.deserialize$2$specifiedType(value, B.FullType_h8g);
            t5.toString;
            A._asString(t5);
            result.get$_connect_request$_$this()._connect_request$_appId = t5;
            break;
          case "instanceId":
            t5 = serializers.deserialize$2$specifiedType(value, B.FullType_h8g);
            t5.toString;
            A._asString(t5);
            result.get$_connect_request$_$this()._instanceId = t5;
            break;
          case "entrypoints":
            t5 = result.get$_connect_request$_$this();
            t6 = t5._entrypoints;
            if (t6 == null) {
              t6 = new A.ListBuilder(t4);
              t6.set$__ListBuilder__list_A(t3._as(A.List_List$from(B.List_empty, true, t2)));
              t6.set$_listOwner(null);
              t5.set$_entrypoints(t6);
              t5 = t6;
            } else
              t5 = t6;
            t6 = serializers.deserialize$2$specifiedType(value, B.FullType_hkZ);
            t6.toString;
            t1._as(t6);
            t7 = t5.$ti;
  ...
  A._$ConnectRequest.prototype = {
    $eq(_, other) {
      ...
      if (other === _this)
        return true;
      return other instanceof A._$ConnectRequest && _this.appName === other.appName && _this.appId === other.appId && _this.instanceId === other.instanceId && _this.entrypoints.$eq(0, other.entrypoints);
    },
    get$hashCode(_) {
      var _this = this;
      return A.$jf(A.$jc(A.$jc(A.$jc(A.$jc(0, B.JSString_methods.get$hashCode(_this.appName)), B.JSString_methods.get$hashCode(_this.appId)), B.JSString_methods.get$hashCode(_this.instanceId)), _this.entrypoints.get$hashCode(0)));
    },
    toString$0(_) {
      var _this = this,
        t1 = $.$get$newBuiltValueToStringHelper().call$1("ConnectRequest"),
        t2 = J.getInterceptor$ax(t1);
      t2.add$2(t1, "appName", _this.appName);
      t2.add$2(t1, "appId", _this.appId);
      t2.add$2(t1, "instanceId", _this.instanceId);
      t2.add$2(t1, "entrypoints", _this.entrypoints);
      return t2.toString$0(t1);
    }
  };
  A.ConnectRequestBuilder.prototype = {
    get$entrypoints() {
      var t1 = this.get$_connect_request$_$this(),
        t2 = t1._entrypoints;
      if (t2 == null) {
        t2 = A.ListBuilder_ListBuilder(B.List_empty, type$.String);
        t1.set$_entrypoints(t2);
        t1 = t2;
      } else
        t1 = t2;
      return t1;
    ...
    get$_connect_request$_$this() {
      ...
      if ($$v != null) {
        _this._appName = $$v.appName;
        _this._connect_request$_appId = $$v.appId;
        _this._instanceId = $$v.instanceId;
        t1 = $$v.entrypoints;
        _this.set$_entrypoints(A.ListBuilder_ListBuilder(t1, t1.$ti._precomputed1));
        _this._connect_request$_$v = null;
      }
      return _this;
    },
    _connect_request$_build$0() {
      var _$failedField, e, _$result0, t1, t2, t3, t4, t5, exception, _this = this,
        _s14_ = "ConnectRequest",
        _s10_ = "instanceId",
        _s11_ = "entrypoints",
        _$result = null;
      try {
        _$result0 = _this._connect_request$_$v;
        if (_$result0 == null) {
          t1 = type$.String;
          t2 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_connect_request$_$this()._appName, _s14_, "appName", t1);
          t3 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_connect_request$_$this()._connect_request$_appId, _s14_, "appId", t1);
          t4 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_connect_request$_$this()._instanceId, _s14_, _s10_, t1);
          t5 = _this.get$entrypoints().build$0();
          _$result0 = new A._$ConnectRequest(t2, t3, t4, t5);
          A.BuiltValueNullFieldError_checkNotNull(t2, _s14_, "appName", t1);
          A.BuiltValueNullFieldError_checkNotNull(t3, _s14_, "appId", t1);
          A.BuiltValueNullFieldError_checkNotNull(t4, _s14_, _s10_, t1);
          A.BuiltValueNullFieldError_checkNotNull(t5, _s14_, _s11_, type$.BuiltList_String);
        }
        _$result = _$result0;
      } catch (exception) {
        ...
        try {
          ...
          _this.get$entrypoints().build$0();
        } catch (exception) {
          e = A.unwrapException(exception);
          t1 = A.BuiltValueNestedFieldError$(_s14_, _$failedField.readLocal$0(), J.toString$0$(e));
          throw A.wrapException(t1);
        }
        throw exception;
      }
      t1 = type$.ConnectRequest;
      t2 = t1._as(_$result);
      A.ArgumentError_checkNotNull(t2, "other", t1);
      _this._connect_request$_$v = t2;
      return _$result;
    },
    set$_entrypoints(_entrypoints) {
      this._entrypoints = type$.nullable_ListBuilder_String._as(_entrypoints);
    }
  };
      ...
      for (; iterator.moveNext$0();) {
        ...
        switch (t1) {
          ...
          case "eventData":
            ...
            t1.toString;
            A._asString(t1);
            result.get$_debug_event$_$this()._debug_event$_eventData = t1;
            break;
          case "timestamp":
            t1 = serializers.deserialize$2$specifiedType(value, B.FullType_kjq);
            t1.toString;
            A._asInt(t1);
            result.get$_debug_event$_$this()._debug_event$_timestamp = t1;
            break;
        }
      }
  ...
  A._$BatchedDebugEventsSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      return ["events", serializers.serialize$2$specifiedType(type$.BatchedDebugEvents._as(object).events, B.FullType_EGl)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
      ...
      for (t1 = type$.BuiltList_nullable_Object, t2 = type$.DebugEvent, t3 = type$.List_DebugEvent, t4 = type$.ListBuilder_DebugEvent; iterator.moveNext$0();) {
        ...
        switch (t5) {
          case "events":
            ...
            t6 = serializers.deserialize$2$specifiedType(value, B.FullType_EGl);
            t6.toString;
            t1._as(t6);
            t7 = t5.$ti;
            t8 = t7._eval$1("_BuiltList<1>");
  ...
  A.DebugEventBuilder.prototype = {
    get$_debug_event$_$this() {
      ...
      if ($$v != null) {
        ...
        _this._debug_event$_eventData = $$v.eventData;
        _this._debug_event$_timestamp = $$v.timestamp;
    ...
    _debug_event$_build$0() {
      ...
      if (_$result == null) {
        ...
        t3 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_debug_event$_$this()._debug_event$_eventData, _s10_, _s9_, t1);
        t4 = type$.int;
        t5 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_debug_event$_$this()._debug_event$_timestamp, _s10_, _s9_0, t4);
  ...
  A.BatchedDebugEventsBuilder.prototype = {
    get$events() {
      var t1 = this.get$_debug_event$_$this(),
        t2 = t1._events;
      if (t2 == null) {
        t2 = A.ListBuilder_ListBuilder(B.List_empty, type$.DebugEvent);
        t1.set$_events(t2);
        t1 = t2;
      } else
        t1 = t2;
      ...
      for (; iterator.moveNext$0();) {
        ...
        switch (t1) {
          ...
          case "tabId":
            ...
            result.get$_debug_info$_$this()._tabId = t1;
            break;
        }
      }
  ...
  A.RegisterEntrypointRequest.prototype = {};
  A._$RegisterEntrypointRequestSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      type$.RegisterEntrypointRequest._as(object);
      return ["appName", serializers.serialize$2$specifiedType(object.appName, B.FullType_h8g), "entrypointPath", serializers.serialize$2$specifiedType(object.entrypointPath, B.FullType_h8g)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
    deserialize$3$specifiedType(serializers, serialized, specifiedType) {
      var t1, value, $$v,
        result = new A.RegisterEntrypointRequestBuilder(),
        iterator = J.get$iterator$ax(type$.Iterable_nullable_Object._as(serialized));
      for (; iterator.moveNext$0();) {
        t1 = iterator.get$current();
        t1.toString;
        ...
        switch (t1) {
          case "appName":
            ...
            t1.toString;
            A._asString(t1);
            $$v = result._register_entrypoint_request$_$v;
            if ($$v != null) {
              result._register_entrypoint_request$_appName = $$v.appName;
              result._entrypointPath = $$v.entrypointPath;
              result._register_entrypoint_request$_$v = null;
            }
            result._register_entrypoint_request$_appName = t1;
            break;
          case "entrypointPath":
            t1 = serializers.deserialize$2$specifiedType(value, B.FullType_h8g);
            t1.toString;
            ...
            result._entrypointPath = t1;
            break;
        }
      }
      return result._register_entrypoint_request$_build$0();
    },
    deserialize$2(serializers, serialized) {
      return this.deserialize$3$specifiedType(serializers, serialized, B.FullType_null_List_empty_false);
    },
    ...
    get$wireName() {
      return "RegisterEntrypointRequest";
    }
  };
  A._$RegisterEntrypointRequest.prototype = {
    $eq(_, other) {
      if (other == null)
        return false;
      if (other === this)
        return true;
      return other instanceof A._$RegisterEntrypointRequest && this.appName === other.appName && this.entrypointPath === other.entrypointPath;
    },
    get$hashCode(_) {
      return A.$jf(A.$jc(A.$jc(0, B.JSString_methods.get$hashCode(this.appName)), B.JSString_methods.get$hashCode(this.entrypointPath)));
    },
    toString$0(_) {
      var t1 = $.$get$newBuiltValueToStringHelper().call$1("RegisterEntrypointRequest"),
        t2 = J.getInterceptor$ax(t1);
      t2.add$2(t1, "appName", this.appName);
      t2.add$2(t1, "entrypointPath", this.entrypointPath);
      return t2.toString$0(t1);
    }
  };
  A.RegisterEntrypointRequestBuilder.prototype = {
    get$_register_entrypoint_request$_$this() {
      var _this = this,
        $$v = _this._register_entrypoint_request$_$v;
      if ($$v != null) {
        _this._register_entrypoint_request$_appName = $$v.appName;
        _this._entrypointPath = $$v.entrypointPath;
        _this._register_entrypoint_request$_$v = null;
      }
      return _this;
    },
    _register_entrypoint_request$_build$0() {
      var t1, t2, t3, _this = this,
        _s25_ = "RegisterEntrypointRequest",
        _s14_ = "entrypointPath",
        _$result = _this._register_entrypoint_request$_$v;
      if (_$result == null) {
        t1 = type$.String;
        t2 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_register_entrypoint_request$_$this()._register_entrypoint_request$_appName, _s25_, "appName", t1);
        t3 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_register_entrypoint_request$_$this()._entrypointPath, _s25_, _s14_, t1);
        _$result = new A._$RegisterEntrypointRequest(t2, t3);
        A.BuiltValueNullFieldError_checkNotNull(t2, _s25_, "appName", t1);
        A.BuiltValueNullFieldError_checkNotNull(t3, _s25_, _s14_, t1);
      }
      A.ArgumentError_checkNotNull(_$result, "other", type$.RegisterEntrypointRequest);
      return _this._register_entrypoint_request$_$v = _$result;
    }
  };
      ...
      for (; iterator.moveNext$0();) {
        ...
        switch (t1) {
          case "eventData":
            ...
            $$v = result._$v;
            if ($$v != null) {
              result._eventData = $$v.eventData;
              result._timestamp = $$v.timestamp;
              result._$v = null;
            }
            result._eventData = t1;
            break;
          case "timestamp":
            t1 = serializers.deserialize$2$specifiedType(value, B.FullType_kjq);
            t1.toString;
  ...
  A.RegisterEventBuilder.prototype = {
    ...
    _build$0() {
      ...
      if (_$result == null) {
        t1 = type$.String;
        t2 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_$this()._eventData, _s13_, _s9_, t1);
        t3 = type$.int;
        t4 = A.BuiltValueNullFieldError_checkNotNull(_this.get$_$this()._timestamp, _s13_, _s9_0, t3);
  ...
  A._$serializers_closure1.prototype = {
    call$0() {
  ...
  A.WebSocketClient.prototype = {
    get$sink() {
      ...
      if (value === $) {
        t2 = t1._controller.__StreamChannelController__foreign_F;
    ...
    get$stream() {
      var t2,
        t1 = this._channel._controller.__StreamChannelController__foreign_F;
  ...
  A.SseClient.prototype = {
    SseClient$2$debugKey(serverUrl, debugKey) {
      ...
      new A._EventStream(t1, "open", false, type$._EventStream_JavaScriptObject).get$first(0).whenComplete$1(new A.SseClient_closure(_this));
      t1 = type$.Function;
      t3 = type$.JavaScriptFunction;
      t4 = type$.void;
      A.callMethod(_this.__SseClient__eventSource_A, _s16_, ["message", t3._as(A.allowInterop(_this.get$_onIncomingMessage(), t1))], t4);
      A.callMethod(_this.__SseClient__eventSource_A, _s16_, ["control", t3._as(A.allowInterop(_this.get$_onIncomingControlMessage(), t1))], t4);
      t4 = type$.nullable_void_Function_JavaScriptObject;
      A._EventStreamSubscription$(_this.__SseClient__eventSource_A, "open", t4._as(new A.SseClient_closure0(_this)), false, t2);
      A._EventStreamSubscription$(_this.__SseClient__eventSource_A, "error", t4._as(new A.SseClient_closure1(_this)), false, t2);
    },
    close$0() {
      var _this = this,
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 6;
              return A._asyncAwait(A.promiseToFuture(A.callMethod(t2._as(self.window), "fetch", [url, t1], type$.JSObject), type$.nullable_Object), $async$call$0);
            case 6:
              // returning from await.
              $async$handler = 1;
              // goto after finally
  ...
  A.Uuid.prototype = {
    ...
    v1$0() {
      var seedBytes, nodeId, t2, t3, clockSeq, mSecs, nSecs, tl, tmh, node, n, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, _this = this,
        _s9_ = "hasInitV1",
        _s9_0 = "seedBytes",
        _s4_ = "node",
        _s8_ = "clockSeq",
        ...
        t1 = _this.get$_uuid$_state().$index(0, _s9_);
      t1.toString;
      if (!A._asBool(t1)) {
        seedBytes = A.UuidUtil_mathRNG();
        if (_this.get$_uuid$_state().$index(0, _s9_0) != null)
          _this.get$_uuid$_state().$index(0, _s9_0);
        else
          _this.get$_uuid$_state().$indexSet(0, _s9_0, seedBytes);
        nodeId = A._setArrayType([seedBytes[0] | 1, seedBytes[1], seedBytes[2], seedBytes[3], seedBytes[4], seedBytes[5]], type$.JSArray_int);
        if (_this.get$_uuid$_state().$index(0, _s4_) != null)
          _this.get$_uuid$_state().$index(0, _s4_);
        else
          _this.get$_uuid$_state().$indexSet(0, _s4_, nodeId);
        t1 = seedBytes[6];
        t2 = seedBytes[7];
        t3 = _this.get$_uuid$_state();
        if (t3.$index(0, _s8_) == null)
          t3.$indexSet(0, _s8_, (t1 << 8 | t2) & 262143);
        _this.get$_uuid$_state().$indexSet(0, _s5_, 0);
        _this.get$_uuid$_state().$indexSet(0, _s5_0, 0);
        _this.get$_uuid$_state().$indexSet(0, _s9_, true);
      }
      options.$index(0, _s8_);
      clockSeq = A._asInt(_this.get$_uuid$_state().$index(0, _s8_));
      options.$index(0, _s5_);
      mSecs = Date.now();
      options.$index(0, _s5_0);
      t1 = _this.get$_uuid$_state().$index(0, _s5_0);
      t1.toString;
      nSecs = A._asInt(t1) + 1;
      t1 = mSecs - A._asNum(_this.get$_uuid$_state().$index(0, _s5_)) + (nSecs - A._asNum(_this.get$_uuid$_state().$index(0, _s5_0))) / 10000 < 0;
      if (t1) {
        options.$index(0, _s8_);
        t2 = true;
      } else
      ...
      if (t1 || mSecs > A._asNum(_this.get$_uuid$_state().$index(0, _s5_))) {
        options.$index(0, _s5_0);
        t1 = true;
      } else
        t1 = false;
      ...
      _this.get$_uuid$_state().$indexSet(0, _s5_, mSecs);
      _this.get$_uuid$_state().$indexSet(0, _s5_0, nSecs);
      _this.get$_uuid$_state().$indexSet(0, _s8_, clockSeq);
      mSecs += 122192928e5;
      ...
      node = type$.List_dynamic._as(_this.get$_uuid$_state().$index(0, _s4_));
  ...
  A._EventStreamSubscription.prototype = {
    ...
    _tryResume$0() {
      ...
      if (t1 != null && _this._pauseCount <= 0) {
        t2 = _this._target;
        t2.toString;
        A.callMethod(t2, "addEventListener", [_this._eventType, t1, false], type$.void);
      }
    },
    _unlisten$0() {
      var t2,
  ...
  A.HtmlWebSocketChannel.prototype = {
    HtmlWebSocketChannel$1(webSocket) {
      ...
      if (t3 === A._asInt(t4.WebSocket.OPEN)) {
        ...
        new A._EventStream(t2, "open", false, type$._EventStream_JavaScriptObject).get$first(0).then$1$1(new A.HtmlWebSocketChannel_closure(_this), type$.Null);
      }
      t1 = type$._EventStream_JavaScriptObject;
      t3 = type$.Null;
      new A._EventStream(t2, "error", false, t1).get$first(0).then$1$1(new A.HtmlWebSocketChannel_closure0(_this), t3);
      A._EventStreamSubscription$(t2, "message", type$.nullable_void_Function_JavaScriptObject._as(_this.get$_innerListen()), false, type$.JavaScriptObject);
      new A._EventStream(t2, "close", false, t1).get$first(0).then$1$1(new A.HtmlWebSocketChannel_closure1(_this), t3);
    },
    _innerListen$1($event) {
      var data, t1, $constructor,
      ...
      if (typeof eventData === "string") {
        ...
        if (typeof eventData === "object") {
          t1 = type$.JSObject;
          t1._as(eventData);
          $constructor = type$.nullable_JavaScriptFunction._as(t1._as(self).ArrayBuffer);
          t1 = $constructor != null && eventData instanceof $constructor;
        } else
          t1 = false;
        data = t1 ? A.NativeUint8List_NativeUint8List$view(type$.NativeByteBuffer._as(eventData), 0, null) : eventData;
      }
      t1 = this._controller.__StreamChannelController__local_F;
    ...
    _listen$0() {
      var t1 = this._controller.__StreamChannelController__local_F;
      t1 === $ && A.throwLateFieldNI("_local");
      t1 = t1.__GuaranteeChannel__streamController_F;
      t1 === $ && A.throwLateFieldNI("_streamController");
  ...
  A.HtmlWebSocketChannel_closure0.prototype = {
    call$1(_) {
      ...
      t1 = t1._controller.__StreamChannelController__local_F;
      t1 === $ && A.throwLateFieldNI("_local");
      t2 = t1.__GuaranteeChannel__sink_F;
      t2 === $ && A.throwLateFieldNI("_sink");
      t2.addError$1(error);
  ...
  A.HtmlWebSocketChannel_closure1.prototype = {
    call$1($event) {
      ...
      t1 = this.$this._controller.__StreamChannelController__local_F;
      t1 === $ && A.throwLateFieldNI("_local");
      t1 = t1.__GuaranteeChannel__sink_F;
      t1 === $ && A.throwLateFieldNI("_sink");
      t1.close$0();
  ...
  A.HtmlWebSocketChannel__listen_closure.prototype = {
    call$1(obj) {
      ...
      t1 = A.jsify(obj);
      t1.toString;
      return A.callMethod(this.$this.innerWebSocket, "send", [t1], type$.void);
    },
    $signature: 11
  };
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 2;
              return A._asyncAwait(A.runClient(), $async$call$0);
            case 2:
              // returning from await.
              // implicit return
              return A._asyncReturn(null, $async$completer);
  ...
  A.runClient_closure.prototype = {
    call$2(appName, entrypointPath) {
      var t1, t2, t3, t4;
      A._asString(appName);
      A._asString(entrypointPath);
      t1 = this.appInfo;
      t2 = type$.JSArray_nullable_Object;
      t3 = type$.String;
      t4 = A.JSArrayExtension_toDartIterable(t2._as(t1.entrypoints), t3);
      if (B.JSArray_methods.contains$1(A.List_List$of(t4, true, t4.$ti._eval$1("ListIterable.E")), entrypointPath))
        return;
      t1 = A.JSArrayExtension_toDartIterable(t2._as(t1.entrypoints), t3);
      B.JSArray_methods.add$1(A.List_List$of(t1, true, t1.$ti._eval$1("ListIterable.E")), entrypointPath);
      if (A._isChromium())
        this.dwdsConnection.sendRegisterEntrypointRequest$2(appName, entrypointPath);
    },
    $signature: 16
  };
  A.runClient_closure0.prototype = {
    call$1(runId) {
      return A.FutureOfVoidToJSPromise_get_toJS(this.manager.hotRestart$1$runId(A._asString(runId)));
    },
    $signature: 85
  };
  A.runClient_closure1.prototype = {
    call$2(kind, eventData) {
      A._asString(kind);
      A._asString(eventData);
      if (A._asBool(this.appInfo.emitDebugEvents))
        this.dwdsConnection.sendDebugEvent$2(kind, eventData);
    },
    $signature: 16
  };
  A.runClient_closure2.prototype = {
    call$0() {
      if (!A._isChromium()) {
        type$.JavaScriptObject._as(self.window).alert("Dart DevTools is only supported on Chromium based browsers.");
        return;
      }
      var t1 = this.appInfo;
      this.dwdsConnection.sendDevToolsRequest$2(A._asString(t1.appId), A._asString(t1.appInstanceId));
    },
    $signature: 2
  };
  A.runClient_closure3.prototype = {
    call$1(serialized) {
      return this.$call$body$runClient_closure(A._asString(serialized));
    },
    $call$body$runClient_closure(serialized) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        $async$self = this, t1, $alert, t2, $event;
      var $async$call$1 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 5:
              // switch
              switch (A._asString($async$self.appInfo.reloadConfiguration)) {
            ...
            case 7:
              // case
              t1 = type$.JavaScriptObject;
              t1._as(t1._as(self.window).location).reload();
              // goto after switch
              $async$goto = 6;
              break;
            case 8:
            ...
            case 4:
              ...
              if ($event instanceof A._$DevToolsResponse) {
                if (!$event.success) {
                  ...
                  t1 = $event.promptExtension && A._asBool(type$.JavaScriptObject._as(self.window).confirm($alert));
                  t2 = type$.JavaScriptObject;
                  if (t1)
                    type$.nullable_JavaScriptObject._as(t2._as(self.window).open("https://goo.gle/dart-debug-extension", "_blank"));
                  else
                ...
                A.callMethod(type$.JavaScriptObject._as(self.window), "reportError", ["Error from backend:\n\nError: " + $event.error + "\n\nStack Trace:\n" + $event.stackTrace], type$.void);
            case 3:
              // join
              // implicit return
              return A._asyncReturn(null, $async$completer);
  ...
  A.runClient_closure4.prototype = {
    call$1(error) {
    },
    $signature: 6
  };
  A.runClient_closure5.prototype = {
    call$1(e) {
      if (B.JSArray_methods.contains$1(B.List_er0, A._asString(e.key)) && A._asBool(e.altKey) && !A._asBool(e.ctrlKey) && !A._asBool(e.metaKey)) {
        e.preventDefault();
  ...
  A.DebugExtensionConnection.prototype = {
    launchCommunication$0() {
      var t1, t2;
      A.callMethod(type$.JavaScriptObject._as(self.window), "addEventListener", ["message", type$.JavaScriptFunction._as(A.allowInterop(this.get$_handleAuthRequest(), type$.Function))], type$.void);
      t1 = $.$get$serializers();
      t2 = new A.DebugInfoBuilder();
      type$.nullable_void_Function_DebugInfoBuilder._as(new A.DebugExtensionConnection_launchCommunication_closure(this)).call$1(t2);
      this._dispatchEvent$2("dart-app-ready", B.C_JsonCodec.encode$2$toEncodable(t1.serialize$1(t2._debug_info$_build$0()), null));
    },
    _getAuthUrl$1(extensionUrl) {
      var authUrl;
    ...
    _dispatchEvent$2(message, detail) {
      var t1 = self,
        t2 = type$.JavaScriptObject;
      A._asBool(t2._as(t1.window).dispatchEvent(t2._as(new t1.CustomEvent("dart-auth-response", t2._as({detail: detail})))));
    },
    _handleAuthRequest$1($event) {
      var authUrl;
      type$.JavaScriptObject._as($event);
      ...
      if (A._asString($event.data) !== "dart-auth-request")
        return;
      authUrl = this._getAuthUrl$1(A._asStringQ(this.appInfo.extensionUrl));
      if (authUrl != null)
        A.DebugExtensionConnection__authenticateUser(authUrl).then$1$1(new A.DebugExtensionConnection__handleAuthRequest_closure(this), type$.void);
    }
  };
  A.DebugExtensionConnection_launchCommunication_closure.prototype = {
    call$1(b) {
      var t4, t5,
        t1 = this.$this,
        t2 = t1.appInfo,
        t3 = A._asString(t2.appName);
      b.get$_debug_info$_$this()._appEntrypointPath = t3;
      t3 = A._asString(t2.appId);
      b.get$_debug_info$_$this()._appId = t3;
      t3 = A._asString(t2.appInstanceId);
      b.get$_debug_info$_$this()._appInstanceId = t3;
      t3 = self;
      t4 = type$.JavaScriptObject;
      t5 = A._asString(t4._as(t4._as(t3.window).location).origin);
      b.get$_debug_info$_$this()._appOrigin = t5;
      t3 = A._asString(t4._as(t4._as(t3.window).location).href);
      b.get$_debug_info$_$this()._appUrl = t3;
      t1 = t1._getAuthUrl$1(A._asStringQ(t2.extensionUrl));
      b.get$_debug_info$_$this()._authUrl = t1;
      t1 = A._asStringQ(t2.extensionUrl);
      b.get$_debug_info$_$this()._extensionUrl = t1;
      t1 = A._asBool(t2.isInternalBuild);
      b.get$_debug_info$_$this()._isInternalBuild = t1;
      t1 = A._asBool(t2.isFlutterApp);
      b.get$_debug_info$_$this()._isFlutterApp = t1;
      t2 = A._asStringQ(t2.workspaceName);
      b.get$_debug_info$_$this()._workspaceName = t2;
      return b;
    },
    $signature: 58
  };
  A.DebugExtensionConnection__handleAuthRequest_closure.prototype = {
    call$1(isAuthenticated) {
      return this.$this._dispatchEvent$2("dart-auth-response", "" + A._asBool(isAuthenticated));
    },
    $signature: 59
  };
  A.DevHandlerConnection.prototype = {
    sendConnectRequest$4(appName, appId, appInstanceId, entrypoints) {
      var t1 = new A.ConnectRequestBuilder();
      type$.nullable_void_Function_ConnectRequestBuilder._as(new A.DevHandlerConnection_sendConnectRequest_closure(appName, appId, appInstanceId, type$.List_String._as(entrypoints))).call$1(t1);
      this._serializeAndTrySendEvent$1$1(t1._connect_request$_build$0(), type$.ConnectRequest);
    },
    sendRegisterEntrypointRequest$2(appName, entrypointPath) {
      var t1 = new A.RegisterEntrypointRequestBuilder();
      type$.nullable_void_Function_RegisterEntrypointRequestBuilder._as(new A.DevHandlerConnection_sendRegisterEntrypointRequest_closure(appName, entrypointPath)).call$1(t1);
      this._serializeAndTrySendEvent$1$1(t1._register_entrypoint_request$_build$0(), type$.RegisterEntrypointRequest);
    },
    _sendBatchedDebugEvents$1(events) {
      var t1 = new A.BatchedDebugEventsBuilder();
      type$.nullable_void_Function_BatchedDebugEventsBuilder._as(new A.DevHandlerConnection__sendBatchedDebugEvents_closure(type$.List_DebugEvent._as(events))).call$1(t1);
      this._serializeAndTrySendEvent$1$1(t1._debug_event$_build$0(), type$.BatchedDebugEvents);
    },
    sendDebugEvent$2(kind, eventData) {
      var t1 = this.debugEventController._inputController,
        t2 = new A.DebugEventBuilder();
      type$.nullable_void_Function_DebugEventBuilder._as(new A.DevHandlerConnection_sendDebugEvent_closure(kind, eventData)).call$1(t2);
      this._trySendEvent$1$2(new A._StreamSinkWrapper(t1, A._instanceType(t1)._eval$1("_StreamSinkWrapper<1>")), t2._debug_event$_build$0(), type$.DebugEvent);
    },
    sendRegisterEvent$1(eventData) {
      var t1 = new A.RegisterEventBuilder();
      type$.nullable_void_Function_RegisterEventBuilder._as(new A.DevHandlerConnection_sendRegisterEvent_closure(A._asString(eventData))).call$1(t1);
      this._serializeAndTrySendEvent$1$1(t1._build$0(), type$.RegisterEvent);
    },
    sendDevToolsRequest$2(appId, appInstanceId) {
      var t1 = new A.DevToolsRequestBuilder();
      type$.nullable_void_Function_DevToolsRequestBuilder._as(new A.DevHandlerConnection_sendDevToolsRequest_closure(appId, appInstanceId)).call$1(t1);
      this._serializeAndTrySendEvent$1$1(t1._devtools_request$_build$0(), type$.DevToolsRequest);
    },
    _trySendEvent$1$2(sink, $event, $T) {
      var exception;
      $T._eval$1("StreamSink<0>")._as(sink);
      $T._as($event);
      try {
        sink.add$1(0, $event);
      } catch (exception) {
        if (A.unwrapException(exception) instanceof A.StateError)
          A.print("Cannot send event " + A.S($event) + ". Injected client connection is closed.");
        else
          throw exception;
      }
    },
    _serializeAndTrySendEvent$1$1(object, $T) {
      var t1;
      $T._as(object);
      t1 = this.__DevHandlerConnection_client_F;
      t1 === $ && A.throwLateFieldNI("client");
      this._trySendEvent$1$2(t1.get$sink(), B.C_JsonCodec.encode$2$toEncodable($.$get$serializers().serialize$1(object), null), type$.dynamic);
    }
  };
  A.DevHandlerConnection_sendConnectRequest_closure.prototype = {
    call$1(b) {
      var t1, _this = this;
      b.get$_connect_request$_$this()._appName = _this.appName;
      b.get$_connect_request$_$this()._connect_request$_appId = _this.appId;
      b.get$_connect_request$_$this()._instanceId = _this.appInstanceId;
      t1 = type$.nullable_ListBuilder_String._as(A.ListBuilder_ListBuilder(_this.entrypoints, type$.String));
      b.get$_connect_request$_$this().set$_entrypoints(t1);
      return b;
    },
    $signature: 62
  };
  A.DevHandlerConnection_sendRegisterEntrypointRequest_closure.prototype = {
    call$1(b) {
      b.get$_register_entrypoint_request$_$this()._register_entrypoint_request$_appName = this.appName;
      b.get$_register_entrypoint_request$_$this()._entrypointPath = this.entrypointPath;
      return b;
    },
    $signature: 63
  };
  A.DevHandlerConnection__sendBatchedDebugEvents_closure.prototype = {
    call$1(b) {
  ...
  A.DevHandlerConnection_sendDebugEvent_closure.prototype = {
    call$1(b) {
      var t1 = Date.now();
      b.get$_debug_event$_$this()._debug_event$_timestamp = t1;
      b.get$_debug_event$_$this()._debug_event$_kind = this.kind;
      b.get$_debug_event$_$this()._debug_event$_eventData = this.eventData;
      return b;
    },
    $signature: 65
  };
  A.DevHandlerConnection_sendRegisterEvent_closure.prototype = {
    call$1(b) {
      var t1 = Date.now();
      b.get$_$this()._timestamp = t1;
      b.get$_$this()._eventData = this.eventData;
      return b;
    },
    $signature: 66
  };
  A.DevHandlerConnection_sendDevToolsRequest_closure.prototype = {
    call$1(b) {
      b.get$_devtools_request$_$this()._devtools_request$_appId = this.appId;
      b.get$_devtools_request$_$this()._devtools_request$_instanceId = this.appInstanceId;
      return b;
    },
    $signature: 67
  };
  ...
  A.RequireRestarter.prototype = {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = A;
              $async$goto = 3;
              return A._asyncAwait(A.HttpRequest_request(A._asString(type$.JavaScriptObject._as(self.$requireLoader).digestsPath), "GET", "json", null), $async$_getDigests$0);
            case 3:
              // returning from await.
              $async$returnValue = $async$temp1._as($async$temp2.dartify($async$result.response)).cast$2$0(0, t1, t1);
              // goto return
              $async$goto = 1;
              break;
            case 1:
    ...
    _moduleParents$1(module) {
      ...
      A._asString(module);
      t1 = type$.JavaScriptObject;
      t1 = A.callMethod(t1._as(t1._as(self.$requireLoader).moduleParentsGraph), "get", [module], type$.nullable_JSArray_nullable_Object);
      if (t1 == null)
        t1 = null;
      else {
        t1 = A.JSArrayExtension_toDartIterable(t1, type$.String);
    ...
    _moduleTopologicalCompare$2(module1, module2) {
      ...
      t1.toString;
      topological = J.compareTo$1$ns(t2, t1);
    ...
    _reload$body$RequireRestarter(modules) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, reloadedModules, moduleId, parentIds, e, t4, t5, t6, exception, _box_0, t1, t2, dart, t3, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            ...
            case 4:
              ...
              t3 = $async$self.get$_moduleTopologicalCompare(), t4 = type$.Function, t5 = type$.JavaScriptFunction;
            case 10:
              // for condition
              if (!(t6 = $async$self.__RequireRestarter__dirtyModules_A, t6._root != null)) {
                // goto after for
                $async$goto = 11;
                break;
              }
              ...
              t6 = A._asString(moduleId);
              parentIds = A.ModuleDependencyGraph_parents(t2._as(t2._as(t1.$requireLoader).moduleParentsGraph), t6);
              $async$goto = J.get$length$asx(parentIds) === 0 ? 12 : 14;
              break;
            case 12:
              // then
              t1.$dartRunMain = t5._as(A.allowInterop(new A.RequireRestarter__reload_closure(_box_0, dart), t4));
              // goto join
              $async$goto = 13;
              break;
            case 14:
            ...
            case 7:
              ...
              if (t3 instanceof A.HotReloadFailedException) {
                e = t3;
    ...
    _reloadModule$1(moduleId) {
      var t1 = new A._Future($.Zone__current, type$._Future_dynamic),
        ...
        t2 = type$.Function,
        t3 = type$.JavaScriptFunction;
      A.callMethod(type$.JavaScriptObject._as(self.$requireLoader), "forceLoadModule", [moduleId, t3._as(A.allowInterop(new A.RequireRestarter__reloadModule_closure(completer), t2)), t3._as(A.allowInterop(new A.RequireRestarter__reloadModule_closure0(completer, stackTrace), t2))], type$.void);
      return t1;
    },
    _updateGraph$0() {
      ...
      t3 = type$.String;
      stronglyConnectedComponents = A.stronglyConnectedComponents(A.JSArrayExtension_toDartIterable(A.callMethod(t1.Array, "from", [type$.JSObject._as(t2.keys())], type$.JSArray_nullable_Object), t3), this.get$_moduleParents(), t3);
  ...
  A.RequireRestarter__reload_closure.prototype = {
    call$0() {
      ...
      t1 = A.JSArrayExtension_toDartIterable(A.callMethod(self.Object, "values", [t1], type$.JSArray_nullable_Object), type$.nullable_Object).get$first(0);
      t1.toString;
  ...
  (function aliases() {
    ...
    _.super$_HashMap$_set = _._collection$_set$2;
  })();
  (function installTearOffs() {
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 80, 0);
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 81, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 82, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 83, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 84, 0);
    _static_1(A, "async___printToZone$closure", "_printToZone", 18);
    ...
    _static_2(A, "collection___defaultEquals$closure", "_defaultEquals0", 13);
    ...
    _instance_1_u(_, "get$isValidKey", "isValidKey$1", 43);
    ...
    _instance_1_u(_, "get$_onOutgoingMessage", "_onOutgoingMessage$1", 51);
    _instance_1_u(A.HtmlWebSocketChannel.prototype, "get$_innerListen", "_innerListen$1", 1);
    _instance_1_u(A.DebugExtensionConnection.prototype, "get$_handleAuthRequest", "_handleAuthRequest$1", 1);
    _instance_1_u(_ = A.DevHandlerConnection.prototype, "get$_sendBatchedDebugEvents", "_sendBatchedDebugEvents$1", 60);
    _instance_1_u(_, "get$sendRegisterEvent", "sendRegisterEvent$1", 18);
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Converter, [A.Base64Encoder, A.Base64Decoder, A.JsonEncoder, A.JsonDecoder, A.Utf8Encoder]);
    ...
    _inherit(A._$RegisterEntrypointRequest, A.RegisterEntrypointRequest);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      RegisterEntrypointRequest: findType("RegisterEntrypointRequest"),
      ...
      nullable_void_Function_RegisterEntrypointRequestBuilder: findType("~(RegisterEntrypointRequestBuilder)?"),
...
;
    ...
    B.FullType_Dx1 = new A.FullType(B.Type_DebugEvent_sSr, B.List_empty0, false);
    B.List_luS = A._setArrayType(makeConstList([B.FullType_Dx1]), type$.JSArray_FullType);
    B.FullType_EGl = new A.FullType(B.Type_BuiltList_iTR, B.List_luS, false);
    B.Type_BuildStatus_ahk = A.typeLiteral("BuildStatus");
    B.FullType_FuN = new A.FullType(B.Type_BuildStatus_ahk, B.List_empty0, false);
    ...
    B.List_00 = A._setArrayType(makeConstList([B.Type_IsolateStart_0, B.Type__$IsolateStart_o3b]), type$.JSArray_Type);
    ...
    B.List_6Bz = A._setArrayType(makeConstList([B.Type_ErrorResponse_Q43, B.Type__$ErrorResponse_xV7]), type$.JSArray_Type);
    B.Type_RunRequest_Pkw = A.typeLiteral("RunRequest");
    B.Type__$RunRequest_Im4 = A.typeLiteral("_$RunRequest");
    B.List_7pl = A._setArrayType(makeConstList([B.Type_RunRequest_Pkw, B.Type__$RunRequest_Im4]), type$.JSArray_Type);
    B.Type__$DebugEvent_EmR = A.typeLiteral("_$DebugEvent");
    B.List_8h5 = A._setArrayType(makeConstList([B.Type_DebugEvent_sSr, B.Type__$DebugEvent_EmR]), type$.JSArray_Type);
    B.Type_RegisterEvent_0zQ = A.typeLiteral("RegisterEvent");
    B.Type__$RegisterEvent_SY6 = A.typeLiteral("_$RegisterEvent");
    B.List_ASY = A._setArrayType(makeConstList([B.Type_RegisterEvent_0zQ, B.Type__$RegisterEvent_SY6]), type$.JSArray_Type);
    B.Type_RegisterEntrypointRequest_3l1 = A.typeLiteral("RegisterEntrypointRequest");
    B.Type__$RegisterEntrypointRequest_RSw = A.typeLiteral("_$RegisterEntrypointRequest");
    B.List_ExN = A._setArrayType(makeConstList([B.Type_RegisterEntrypointRequest_3l1, B.Type__$RegisterEntrypointRequest_RSw]), type$.JSArray_Type);
    ...
    B.List_J12 = A._setArrayType(makeConstList([B.Type_IsolateExit_D1o, B.Type__$IsolateExit_eWg]), type$.JSArray_Type);
    ...
    B.List_Jeh = A._setArrayType(makeConstList([B.Type_BatchedDebugEvents_I6f, B.Type__$BatchedDebugEvents_aD9]), type$.JSArray_Type);
    ...
    B.List_Type_BuildStatus_ahk = A._setArrayType(makeConstList([B.Type_BuildStatus_ahk]), type$.JSArray_Type);
    ...
    B.List_aRS = A._setArrayType(makeConstList([B.Type_DevToolsResponse_Hhy, B.Type__$DevToolsResponse_23h]), type$.JSArray_Type);
    ...
    B.List_er0 = A._setArrayType(makeConstList(["d", "D", "\u2202", "\xce"]), type$.JSArray_String);
    B.Type_BuildResult_dEV = A.typeLiteral("BuildResult");
    B.Type__$BuildResult_knt = A.typeLiteral("_$BuildResult");
    B.List_kqK = A._setArrayType(makeConstList([B.Type_BuildResult_dEV, B.Type__$BuildResult_knt]), type$.JSArray_Type);
    B.Type_ConnectRequest_UGQ = A.typeLiteral("ConnectRequest");
    B.Type__$ConnectRequest_cJC = A.typeLiteral("_$ConnectRequest");
    B.List_muk = A._setArrayType(makeConstList([B.Type_ConnectRequest_UGQ, B.Type__$ConnectRequest_cJC]), type$.JSArray_Type);
    ...
    B.Type_Int32_Mhf = A.typeLiteral("Int32");
  ...
  (function lazyInitializers() {
    ...
    _lazy($, "_$registerEntrypointRequestSerializer", "$get$_$registerEntrypointRequestSerializer", () => new A._$RegisterEntrypointRequestSerializer());
    ...
    _lazy($, "_$serializers", "$get$_$serializers", () => {
      ...
      t1.add$1(0, $.$get$_$registerEntrypointRequestSerializer());
      t1.add$1(0, $.$get$_$registerEventSerializer());
      t1.add$1(0, $.$get$_$runRequestSerializer());
      t1.addBuilderFactory$2(B.FullType_EGl, new A._$serializers_closure());
      t1.addBuilderFactory$2(B.FullType_NIe, new A._$serializers_closure0());
      t1.addBuilderFactory$2(B.FullType_hkZ, new A._$serializers_closure1());
      return t1.build$0();
    });
