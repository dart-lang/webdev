// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.3.0-279.0.dev.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    _launchCommunicationWithDebugExtension() {
      var t1, t2;
      A.callMethod(type$.JavaScriptObject._as(self.window), "addEventListener", ["message", type$.JavaScriptFunction._as(A.allowInterop(A.client___handleAuthRequest$closure(), type$.Function))], type$.void);
      t1 = $.$get$serializers();
    ...
    _dispatchEvent(message, detail) {
      var t1 = self,
        t2 = type$.JavaScriptObject,
        $event = t2._as(new t1.CustomEvent(message, t2._as({detail: detail})));
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$temp2 = A;
              $async$goto = 3;
              return A._asyncAwait(A.HttpRequest_request(authUrl, "GET", null, true), $async$_authenticateUser);
            case 3:
    ...
    _authUrl() {
      var authUrl,
        extensionUrl = A._asStringQ(A.dartify(type$.JSObject._as(self.window).$dartExtensionUri));
  ...
  A.main_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        uri, t2, fixedPath, fixedUri, client, restarter, manager, t3, t4, t5, t6, t7, t8, debugEventController, t9, t1;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (A._asStringQ(t1.$dartAppInstanceId) == null)
                t1.$dartAppInstanceId = B.C_Uuid.v1$0();
              ...
              $async$goto = A._asString(t1.$dartModuleStrategy) === "require-js" ? 2 : 4;
              break;
            case 2:
              // then
              $async$goto = 5;
            ...
            case 4:
              ...
              if (A._asString(t1.$dartModuleStrategy) === "legacy")
                ...
                throw A.wrapException(A.StateError$("Unknown module strategy: " + A.S(A.getProperty(A.staticInteropGlobalContext(), "$dartModuleStrategy", type$.String))));
            case 3:
              // join
              manager = new A.ReloadingManager(client, restarter);
              t3 = type$.Function;
              t4 = type$.JavaScriptFunction;
              t1.$dartHotRestartDwds = t4._as(A.allowInterop(new A.main__closure(manager), t3));
              t5 = $.Zone__current;
              t6 = Math.max(100, 1);
              ...
              debugEventController = new A.BatchedStreamController(t6, 1000, t7, t8, new A._AsyncCompleter(new A._Future(t5, type$._Future_bool), type$._AsyncCompleter_bool), type$.BatchedStreamController_DebugEvent);
              t5 = A.List_List$filled(A.QueueList__computeInitialCapacity(null), null, false, type$.nullable_Result_DebugEvent);
              t6 = A.ListQueue$(type$._EventRequest_dynamic);
              t9 = type$.StreamQueue_DebugEvent;
              debugEventController.set$__BatchedStreamController__inputQueue_A(t9._as(new A.StreamQueue(new A._ControllerStream(t7, A._instanceType(t7)._eval$1("_ControllerStream<1>")), new A.QueueList(t5, 0, 0, type$.QueueList_Result_DebugEvent), t6, t9)));
              A.safeUnawaited(debugEventController._batchAndSendEvents$0());
              new A._ControllerStream(t8, A._instanceType(t8)._eval$1("_ControllerStream<1>")).listen$1(new A.main__closure0(client));
              t1.$emitDebugEvent = t4._as(A.allowInterop(new A.main__closure1(debugEventController), t3));
              t1.$emitRegisterEvent = t4._as(A.allowInterop(new A.main__closure2(client), t3));
              t1.$launchDevTools = t4._as(A.allowInterop(new A.main__closure3(client), t3));
              client.get$stream().listen$2$onError(new A.main__closure4(manager), new A.main__closure5());
              if (A._asBool(t1.$dwdsEnableDevToolsLaunch))
                A._EventStreamSubscription$(t2._as(t1.window), "keydown", type$.nullable_void_Function_JavaScriptObject._as(new A.main__closure6()), false, t2);
              if (A._isChromium()) {
                t1 = client.get$sink();
                t2 = $.$get$serializers();
  ...
  A._launchCommunicationWithDebugExtension_closure.prototype = {
    call$1(b) {
      ...
      t2 = type$.JSObject;
      t3 = A._asStringQ(A.dartify(t2._as(t1.window).$dartAppId));
      ...
      t3 = A._asStringQ(A.dartify(t2._as(t1.window).$dartExtensionUri));
      b.get$_$this()._extensionUrl = t3;
      t3 = A._asBoolQ(A.dartify(t2._as(t1.window).$isInternalBuild));
      b.get$_$this()._isInternalBuild = t3;
      t2 = A._asBoolQ(A.dartify(t2._as(t1.window).$isFlutterApp));
  ...
  A.RequireRestarter.prototype = {
    restart$1$runId(runId) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$self = this, newDigests, modulesToLoad, t4, t5, t6, t7, line, toZone, t8, result, t1, t2, t3, sdk, dart, developer;
      var $async$restart$1$runId = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t2 = type$.nullable_Object;
              t3 = type$.JSObject;
              sdk = t3._as(A.callMethod(type$.JavaScriptFunction._as(t1.$loadModuleConfig), "call", [null, "dart_sdk"], t2));
              dart = t3._as(sdk.dart);
              developer = t3._as(sdk.developer);
              $async$goto = A._asBool(A.dartify(A.JSObjectUnsafeUtilExtension_callMethod(t3._as(developer._extensions), "containsKey", "ext.flutter.disassemble", null, t2))) ? 3 : 4;
              break;
            case 3:
              // then
              $async$goto = 5;
              return A._asyncAwait(type$.Future_nullable_Object._as(A.dartify(A.JSObjectUnsafeUtilExtension_callMethod(developer, "invokeExtension", "ext.flutter.disassemble", "{}", t2))), $async$restart$1$runId);
            case 5:
              // returning from await.
            case 4:
              // join
            ...
            case 6:
              ...
              for (t3 = newDigests.get$keys(), t3 = t3.get$iterator(t3), t4 = $.RequireRestarter____lastKnownDigests._name, t5 = type$.JavaScriptObject; t3.moveNext$0();) {
                t6 = t3.get$current();
            ...
            case 8:
              // join
              A.JSObjectUnsafeUtilExtension_callMethod(dart, "hotRestart", runId == null ? null : runId, null, t2);
              A.runMain();
              $async$returnValue = result;
              // goto return
              $async$goto = 1;
    ...
    _reload$body$RequireRestarter(modules) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, reloadedModules, previousModuleId, moduleId, parentIds, childModule, mainLibrary, e, t6, t7, t8, t9, exception, t1, t2, t3, t4, dart, t5, $async$exception;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t3 = type$.nullable_Object;
              t4 = type$.JSObject;
              dart = t4._as(t4._as(A.callMethod(t2._as(t1.$loadModuleConfig), "call", [null, "dart_sdk"], t3)).dart);
              t5 = $async$self._running.future;
              $async$goto = (t5._state & 30) === 0 ? 3 : 4;
              break;
            case 3:
              // then
              $async$goto = 5;
              return A._asyncAwait(t5, $async$_reload$1);
            case 5:
              // returning from await.
            ...
            case 4:
              ...
              reloadedModules = 0;
              $async$handler = 7;
              t5 = $async$self.__RequireRestarter__dirtyModules_A;
              t5 === $ && A.throwLateFieldNI("_dirtyModules");
              t5.addAll$1(0, modules);
              previousModuleId = null;
              t5 = $async$self.get$_moduleTopologicalCompare(), t6 = type$.JavaScriptObject, t7 = type$.Function, t8 = type$.JSArray_nullable_Object;
            case 10:
              // for condition
              ...
              if (t9._count === 0)
                A.throwExpression(A.IterableElementError_noElement());
              moduleId = t9.get$_collection$_first().key;
              $async$self.__RequireRestarter__dirtyModules_A.remove$1(0, moduleId);
              t9 = A._asString(moduleId);
              parentIds = A.ModuleDependencyGraph_parents(t6._as(t6._as(t1.$requireLoader).moduleParentsGraph), t9);
            ...
            case 12:
              ...
              if (t9 == null)
                t9 = null;
              childModule = t4._as(A.JSObjectUnsafeUtilExtension__callMethod(dart, "getModuleLibraries", t9, null, null, null));
              t9 = t1.Object;
              t9 = A.JSArrayExtension_toDartIterable(t8._as(t9.values.apply(t9, [childModule])), t3);
              if (t9.get$length(0) === 0)
                A.throwExpression(A.IterableElementError_noElement());
              t9 = t9.elementAt$1(0, 0);
              t9.toString;
              mainLibrary = t4._as(t9);
              t1.$dartRunMain = t2._as(A.allowInterop(new A.RequireRestarter__reload_closure(mainLibrary), t7));
              // goto join
              $async$goto = 13;
              break;
            case 14:
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 78, 0);
    ...
    _static_1(A, "async___printToZone$closure", "_printToZone", 83);
    ...
    _instance_1_u(_, "get$_onOutgoingMessage", "_onOutgoingMessage$1", 50);
    _instance_1_u(A.HtmlWebSocketChannel.prototype, "get$_innerListen", "_innerListen$1", 1);
    _static_1(A, "client___handleAuthRequest$closure", "_handleAuthRequest", 1);
    _instance_1_u(_ = A.RequireRestarter.prototype, "get$_moduleParents", "_moduleParents$1", 67);
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(JavaScriptObject)", "Null()", "Object?(@)", "@(@)", "Null(Object,StackTrace)", "Null(@)", "Null(JavaScriptObject)", "~(@)", "int(Object?)", "~(Object,StackTrace)", "~(Object?)", "~(~())", "bool(Object?,Object?)", "Object?(Object?)", "~(Object[StackTrace?])", "String(int,int)", "bool()", "~(@,StackTrace)", "bool(@)", "~(@,@)", "~(Object?,Object?)", "int(int,int)", "int(int)", "~(Symbol0,@)", "~(Uint8List,String,int)", "Future<Null>()", "String(String)", "~(String,int?)", "~(String,int)", "Null(JavaScriptFunction,JavaScriptFunction)", "Object?(~)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "int(int,@)", "IndentingBuiltValueToStringHelper(String)", "ListBuilder<Object>()", "ListMultimapBuilder<Object,Object>()", "MapBuilder<Object,Object>()", "SetBuilder<Object>()", "SetMultimapBuilder<Object,Object>()", "@(@,String)", "_Future<@>(@)", "Null(~())", "bool(Object?)", "ListBuilder<DebugEvent>()", "ListBuilder<ExtensionEvent>()", "~(int,@)", "String(@)", "Logger()", "@(String)", "~(String?)", "Null(@,StackTrace)", "~(String,@)", "Future<~>()", "JSObject(String)", "~(List<DebugEvent>)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Null(String,String)", "DebugEventBuilder(DebugEventBuilder)", "Null(String)", "RegisterEventBuilder(RegisterEventBuilder)", "DevToolsRequestBuilder(DevToolsRequestBuilder)", "Future<~>(String)", "ConnectRequestBuilder(ConnectRequestBuilder)", "DebugInfoBuilder(DebugInfoBuilder)", "~(bool)", "bool(bool)", "List<String>(String)", "int(String,String)", "int(@,@)", "ListBuilder<DebugEvent>(BatchedDebugEventsBuilder)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Uint8List(@,@)"],
