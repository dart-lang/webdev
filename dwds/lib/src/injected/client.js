// Generated by dart2js (, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.11.0-edge.7e4cc3dabdc3a03bb728a005062de00dbc87ea40.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    DdcLibraryBundleRestarter: function DdcLibraryBundleRestarter() {
      this._currentRestart = this._capturedHotReloadEndCallback = null;
    },
    ...
    DdcLibraryBundleRestarter_restart_closure: function DdcLibraryBundleRestarter_restart_closure(t0, t1, t2) {
      this.$this = t0;
      this.readyToRunMain = t1;
      this.reloadedSourcesPath = t2;
    },
    DdcLibraryBundleRestarter_restart__closure: function DdcLibraryBundleRestarter_restart__closure(t0, t1) {
      this.$this = t0;
      this.readyToRunMain = t1;
    },
    DdcLibraryBundleRestarter_restart_closure0: function DdcLibraryBundleRestarter_restart_closure0(t0) {
      this.$this = t0;
    },
  ...
  A.DdcLibraryBundleRestarter.prototype = {
    ...
    restart$3$readyToRunMain$reloadedSourcesPath$runId(readyToRunMain, reloadedSourcesPath, runId) {
      var _this = this,
        t1 = _this._currentRestart;
      if (t1 != null)
        return t1;
      return _this._currentRestart = new A.DdcLibraryBundleRestarter_restart_closure(_this, readyToRunMain, reloadedSourcesPath).call$0().whenComplete$1(new A.DdcLibraryBundleRestarter_restart_closure0(_this));
    },
  ...
  A.DdcLibraryBundleRestarter_restart_closure.prototype = {
    call$0() {
      var $async$goto = 0,
        ...
        $async$returnValue, $async$self = this, t2, mainHandler, t3, srcModuleLibraries, t1;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        for (;;)
          switch ($async$goto) {
            case 0:
              ...
              t1 = init.G;
              $async$goto = 3;
              return A._asyncAwait(A._Debugger_maybeInvokeFlutterDisassemble(A._asJSObject(A._asJSObject(t1.dartDevEmbedder).debugger)), $async$call$0);
            case 3:
              // returning from await.
              t2 = $async$self.$this;
              mainHandler = A._functionToJS1(new A.DdcLibraryBundleRestarter_restart__closure(t2, $async$self.readyToRunMain));
              A._asJSObject(A._asJSObject(t1.dartDevEmbedder).config).capturedMainHandler = mainHandler;
              t3 = $async$self.reloadedSourcesPath;
              t3.toString;
              $async$goto = 4;
              return A._asyncAwait(t2._getSrcModuleLibraries$1(t3), $async$call$0);
            case 4:
              // returning from await.
              srcModuleLibraries = $async$result;
              $async$goto = 5;
              return A._asyncAwait(A.promiseToFuture(A._asJSObject(A._asJSObject(t1.dartDevEmbedder).hotRestart()), type$.nullable_Object), $async$call$0);
            case 5:
              // returning from await.
  ...
  A.DdcLibraryBundleRestarter_restart__closure.prototype = {
    call$1(runMain) {
  ...
  A.DdcLibraryBundleRestarter_restart_closure0.prototype = {
    call$0() {
      this.$this._currentRestart = null;
    },
    $signature: 1
  };
  ...
  (function installTearOffs() {
    ...
    _static(A, "async___rootHandleUncaughtError$closure", 5, null, ["call$5"], ["_rootHandleUncaughtError"], 77, 0);
    ...
    _static(A, "async___rootErrorCallback$closure", 5, null, ["call$5"], ["_rootErrorCallback"], 84, 0);
    _static(A, "async___rootScheduleMicrotask$closure", 4, null, ["call$4"], ["_rootScheduleMicrotask"], 85, 0);
    _static(A, "async___rootCreateTimer$closure", 5, null, ["call$5"], ["_rootCreateTimer"], 86, 0);
    _static(A, "async___rootCreatePeriodicTimer$closure", 5, null, ["call$5"], ["_rootCreatePeriodicTimer"], 87, 0);
    _static(A, "async___rootPrint$closure", 4, null, ["call$4"], ["_rootPrint"], 88, 0);
    _static_1(A, "async___printToZone$closure", "_printToZone", 89);
    _static(A, "async___rootFork$closure", 5, null, ["call$5"], ["_rootFork"], 90, 0);
    _instance(A._Completer.prototype, "get$completeError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 59, 0, 0);
    ...
    _static_1(A, "client__initializeConnection$closure", "initializeConnection", 62);
    _static_1(A, "client___handleAuthRequest$closure", "_handleAuthRequest", 2);
    _instance_1_u(_ = A.RequireRestarter.prototype, "get$_moduleParents", "_moduleParents$1", 71);
    _instance_2_u(_, "get$_moduleTopologicalCompare", "_moduleTopologicalCompare$2", 72);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "Null()", "~(JSObject)", "Null(Object,StackTrace)", "Null(@)", "~(@)", "~(Object,StackTrace)", "~(Object?)", "JSObject()", "~(~())", "Future<~>()", "String(String)", "Object?(Object?)", "bool(_Highlight)", "Null(JSObject)", "Null(String)", "int(Object?)", "~(Object?,Object?)", "@()", "Null(JavaScriptFunction,JavaScriptFunction)", "@(@)", "int()", "bool()", "Future<~>(String)", "~(@,StackTrace)", "String(Match)", "bool(String)", "Null(JavaScriptFunction)", "int(@,@)", "bool(Object?,Object?)", "~(String,String)", "String(@)", "Null(@,StackTrace)", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "Future<~>(WebSocketEvent)", "bool(String,String)", "int(String)", "Null(String,String[Object?])", "bool(Object)", "~(List<int>)", "MediaType()", "bool(Object?)", "JSObject(Object,StackTrace)", "Logger()", "Object?(~)", "String(String?)", "Null(~)", "PersistentWebSocket(WebSocket)", "int(_Line)", "~(int,@)", "Object(_Line)", "Object(_Highlight)", "int(_Highlight,_Highlight)", "List<_Line>(MapEntry<Object,List<_Highlight>>)", "Map<String,@>(DebugEvent)", "SourceSpanWithContext()", "_Future<@>?()", "~(String?)", "Future<Null>()", "~(Object[StackTrace?])", "Null(~())", "JSObject(String[bool?])", "~(StreamSink<@>)", "~(List<DebugEvent>)", "Null(String,String)", "~(bool)", "HotReloadResponse(String,bool,String?)", "0^(0^,0^)<num>", "Future<+(bool,JSArray<Object?>)>()", "bool(BuildStatus)", "bool(bool)", "List<String>(String)", "int(String,String)", "Null(JavaScriptObject)", "JSObject()()", "0&()", "@(@,String)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "0&(String,int?)", "@(String)", "HotRestartResponse(String,bool,String?)", "String?()"],
