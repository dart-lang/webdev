// Generated by dart2js (NullSafetyMode.sound, csp, intern-composite-values), the Dart to JavaScript compiler version: 3.6.0-134.0.dev.
...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    Serializers_Serializers() {
      ...
      t2.add$1(0, new A.Int32Serializer(A.BuiltList_BuiltList$from([B.Type_Int32_kyU], t1)));
    ...
    _launchCommunicationWithDebugExtension() {
      var t1, t2;
      type$.JavaScriptObject._as(self.window).addEventListener("message", A._functionToJS1(A.client___handleAuthRequest$closure()));
      t1 = $.$get$serializers();
    ...
    runMain() {
      ...
      t1 = type$.nullable_JavaScriptObject._as(type$.JavaScriptObject._as(self.document).body);
      t1.toString;
  ...
  A._$BuildResultSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      return ["status", serializers.serialize$2$specifiedType(type$.BuildResult._as(object).status, B.FullType_KDE)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
    deserialize$3$specifiedType(serializers, serialized, specifiedType) {
      ...
      for (t1 = type$.BuildStatus; iterator.moveNext$0();) {
        ...
        switch (t2) {
          case "status":
            t2 = serializers.deserialize$2$specifiedType(value, B.FullType_KDE);
            t2.toString;
            t1._as(t2);
  ...
  A._$ConnectRequestSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      return ["appId", serializers.serialize$2$specifiedType(object.appId, B.FullType_iHz), "instanceId", serializers.serialize$2$specifiedType(object.instanceId, B.FullType_iHz), "entrypointPath", serializers.serialize$2$specifiedType(object.entrypointPath, B.FullType_iHz)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
  ...
  A._$DebugEventSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      return ["kind", serializers.serialize$2$specifiedType(object.kind, B.FullType_iHz), "eventData", serializers.serialize$2$specifiedType(object.eventData, B.FullType_iHz), "timestamp", serializers.serialize$2$specifiedType(object.timestamp, B.FullType_xEI)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
  ...
  A._$BatchedDebugEventsSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      return ["events", serializers.serialize$2$specifiedType(type$.BatchedDebugEvents._as(object).events, B.FullType_46c)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
      ...
      for (t1 = type$.BuiltList_nullable_Object, t2 = type$.DebugEvent, t3 = type$.List_DebugEvent, t4 = type$.ListBuilder_DebugEvent; iterator.moveNext$0();) {
        ...
        switch (t5) {
          case "events":
            ...
            t6 = serializers.deserialize$2$specifiedType(value, B.FullType_46c);
            t6.toString;
            t1._as(t6);
            t7 = t5.$ti;
  ...
  A._$DevToolsResponseSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      result = ["success", serializers.serialize$2$specifiedType(object.success, B.FullType_mpw), "promptExtension", serializers.serialize$2$specifiedType(object.promptExtension, B.FullType_mpw)];
      value = object.error;
      if (value != null) {
        result.push("error");
        result.push(serializers.serialize$2$specifiedType(value, B.FullType_iHz));
  ...
  A._$ErrorResponseSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      return ["error", serializers.serialize$2$specifiedType(object.error, B.FullType_iHz), "stackTrace", serializers.serialize$2$specifiedType(object.stackTrace, B.FullType_iHz)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
  ...
  A._$RegisterEventSerializer.prototype = {
    serialize$3$specifiedType(serializers, object, specifiedType) {
      ...
      return ["eventData", serializers.serialize$2$specifiedType(object.eventData, B.FullType_iHz), "timestamp", serializers.serialize$2$specifiedType(object.timestamp, B.FullType_xEI)];
    },
    serialize$2(serializers, object) {
      return this.serialize$3$specifiedType(serializers, object, B.FullType_null_List_empty_false);
    },
  ...
  A.HtmlWebSocketChannel__listen_closure.prototype = {
    call$1(obj) {
      ...
      t1 = A.jsify(obj);
      t1.toString;
      return this.$this.innerWebSocket.send(t1);
    },
    $signature: 11
  };
  ...
  A.main_closure.prototype = {
    ...
    $call$body$main_closure() {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.void),
        uri, t3, fixedPath, fixedUri, client, restarter, manager, t4, t5, t6, debugEventController, t7, t1, t2;
      var $async$call$0 = A._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        if ($async$errorCode === 1)
          return A._asyncRethrow($async$result, $async$completer);
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = {};
              t2 = self;
              if (A._asStringQ(t2.$dartAppInstanceId) == null)
                t2.$dartAppInstanceId = new A.UuidV1(null).generate$1$options(null);
              uri = A.Uri_parse(A._asString(t2.$dwdsDevHandlerPath));
              t3 = type$.JavaScriptObject;
              if (A._asString(t3._as(t3._as(t2.window).location).protocol) === "https:" && uri.get$scheme() === "http" && uri.get$host() !== "localhost")
                uri = uri.replace$1$scheme("https");
              else if (A._asString(t3._as(t3._as(t2.window).location).protocol) === "wss:" && uri.get$scheme() === "ws" && uri.get$host() !== "localhost")
              ...
              $async$goto = A._asString(t2.$dartModuleStrategy) === "require-js" ? 2 : 4;
              break;
            case 2:
              // then
              $async$goto = 5;
            ...
            case 3:
              ...
              t2.$dartHotRestartDwds = A._functionToJS2(new A.main__closure(t1, manager));
              t2.$dartReadyToRunMain = A._functionToJS0(new A.main__closure0(t1));
              t1 = $.Zone__current;
              t4 = Math.max(100, 1);
              ...
              debugEventController = new A.BatchedStreamController(t4, 1000, t5, t6, new A._AsyncCompleter(new A._Future(t1, type$._Future_bool), type$._AsyncCompleter_bool), type$.BatchedStreamController_DebugEvent);
              t1 = A.List_List$filled(A.QueueList__computeInitialCapacity(null), null, false, type$.nullable_Result_DebugEvent);
              t4 = A.ListQueue$(type$._EventRequest_dynamic);
              t7 = type$.StreamQueue_DebugEvent;
              debugEventController.set$__BatchedStreamController__inputQueue_A(t7._as(new A.StreamQueue(new A._ControllerStream(t5, A._instanceType(t5)._eval$1("_ControllerStream<1>")), new A.QueueList(t1, 0, 0, type$.QueueList_Result_DebugEvent), t4, t7)));
              ...
              t2.$emitDebugEvent = A._functionToJS2(new A.main__closure2(debugEventController));
              t2.$emitRegisterEvent = A._functionToJS1(new A.main__closure3(client));
              t2.$launchDevTools = A._functionToJS0(new A.main__closure4(client));
              client.get$stream().listen$2$onError(new A.main__closure5(manager), new A.main__closure6());
              if (A._asBool(t2.$dwdsEnableDevToolsLaunch))
                A._EventStreamSubscription$(t3._as(t2.window), "keydown", type$.nullable_void_Function_JavaScriptObject._as(new A.main__closure7()), false, t3);
              if (A._isChromium()) {
                t1 = client.get$sink();
                t2 = $.$get$serializers();
          ...
          switch ($async$goto) {
            ...
            case 4:
              ...
              if ($event instanceof A._$DevToolsResponse) {
                ...
                type$.JavaScriptObject._as(self.window).reportError("Error from backend:\n\nError: " + $event.error + "\n\nStack Trace:\n" + $event.stackTrace);
            case 3:
              // join
              // implicit return
              return A._asyncReturn(null, $async$completer);
  ...
  A.main__closure7.prototype = {
    call$1(e) {
      if (B.JSArray_methods.contains$1(B.List_2ZF, A._asString(e.key)) && A._asBool(e.altKey) && !A._asBool(e.ctrlKey) && !A._asBool(e.metaKey)) {
        e.preventDefault();
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              t1 = self;
              t2 = type$.JavaScriptObject;
              t3 = t2._as(t1.dart_library);
              t4 = readyToRunMain == null ? null : A.FutureOfVoidToJSPromise_get_toJS(readyToRunMain);
              t3.reload(runId, t4);
              t4 = new A._Future($.Zone__current, type$._Future_bool);
              $async$returnValue = t4.then$1$1(new A.DdcRestarter_restart_closure(A._EventStreamSubscription$(t2._as(t1.window), "message", type$.nullable_void_Function_JavaScriptObject._as(new A.DdcRestarter_restart_closure0(new A._AsyncCompleter(t4, type$._AsyncCompleter_bool))), false, t2)), type$.bool);
              // goto return
              $async$goto = 1;
              break;
            case 1:
  ...
  A.RequireRestarter.prototype = {
    ...
    _reload$body$RequireRestarter(modules) {
      var $async$goto = 0,
        $async$completer = A._makeAsyncAwaitCompleter(type$.bool),
        $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, reloadedModules, moduleId, parentIds, e, t4, t5, t6, t7, t8, _this, parentIds0, result, exception, _box_0, t1, t2, dart, t3, $async$exception;
  ...
  (function installTearOffs() {
    ...
    _instance(_, "get$addError", 0, 1, null, ["call$2", "call$1"], ["addError$2", "addError$1"], 16, 0, 0);
    ...
    _instance_1_u(_, "get$hash", "hash$1", 14);
    ...
    _instance_1_u(_, "get$_onOutgoingMessage", "_onOutgoingMessage$1", 48);
    ...
    _instance_1_u(_ = A.RequireRestarter.prototype, "get$_moduleParents", "_moduleParents$1", 65);
    _instance_2_u(_, "get$_moduleTopologicalCompare", "_moduleTopologicalCompare$2", 66);
  })();
  ...
  var init = {
    ...
    mangledNames: {},
    types: ["~()", "~(JavaScriptObject)", "Null()", "Object?(@)", "@(@)", "Null(Object,StackTrace)", "Null(@)", "~(@)", "Null(JavaScriptObject)", "~(Object,StackTrace)", "~(~())", "~(Object?)", "Object?(Object?)", "bool(Object?,Object?)", "int(Object?)", "JavaScriptObject()", "~(Object[StackTrace?])", "~(@,StackTrace)", "bool(@)", "~(@,@)", "~(Object?,Object?)", "int(int,int)", "int(int)", "~(Uint8List,String,int)", "Future<Null>()", "bool()", "String(int,int)", "Null(JavaScriptFunction,JavaScriptFunction)", "@(@,String)", "Object?(~)", "Null(~())", "int(int,@)", "IndentingBuiltValueToStringHelper(String)", "ListBuilder<Object>()", "ListMultimapBuilder<Object,Object>()", "MapBuilder<Object,Object>()", "SetBuilder<Object>()", "SetMultimapBuilder<Object,Object>()", "Null(@,StackTrace)", "~(int,@)", "@(String)", "bool(Object?)", "ListBuilder<DebugEvent>()", "ListBuilder<ExtensionEvent>()", "~(String,int)", "String(@)", "Logger()", "~(String,int?)", "~(String?)", "String(String)", "Uint8List(@,@)", "Future<~>()", "JSObject(String[bool?])", "~(List<DebugEvent>)", "ListBuilder<DebugEvent>(BatchedDebugEventsBuilder)", "Null(String,String)", "Zone(Zone?,ZoneDelegate?,Zone,ZoneSpecification?,Map<Object?,Object?>?)", "Null(String)", "RegisterEventBuilder(RegisterEventBuilder)", "DevToolsRequestBuilder(DevToolsRequestBuilder)", "Future<~>(String)", "ConnectRequestBuilder(ConnectRequestBuilder)", "DebugInfoBuilder(DebugInfoBuilder)", "~(bool)", "bool(bool)", "List<String>(String)", "int(String,String)", "JavaScriptObject()()", "~(Zone,ZoneDelegate,Zone,Object,StackTrace)", "int(@,@)", "DebugEventBuilder(DebugEventBuilder)", "~(Zone?,ZoneDelegate?,Zone,Object,StackTrace)", "0^(Zone?,ZoneDelegate?,Zone,0^())<Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^),1^)<Object?,Object?>", "0^(Zone?,ZoneDelegate?,Zone,0^(1^,2^),1^,2^)<Object?,Object?,Object?>", "0^()(Zone,ZoneDelegate,Zone,0^())<Object?>", "0^(1^)(Zone,ZoneDelegate,Zone,0^(1^))<Object?,Object?>", "0^(1^,2^)(Zone,ZoneDelegate,Zone,0^(1^,2^))<Object?,Object?,Object?>", "AsyncError?(Zone,ZoneDelegate,Zone,Object,StackTrace?)", "~(Zone?,ZoneDelegate?,Zone,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~())", "Timer(Zone,ZoneDelegate,Zone,Duration,~(Timer))", "~(Zone,ZoneDelegate,Zone,String)", "~(String)", "_Future<@>(@)"],
  ...
  A._Universe_addErasedTypes(init.typeUniverse, JSON.parse('{"UnmodifiableListBase":1,"NativeTypedArray":1,"_DelayedEvent":1,"_SplayTreeSet__SplayTree_Iterable":1,"_SplayTreeSet__SplayTree_Iterable_SetMixin":1,"MapEntry":2,"_QueueList_Object_ListMixin":1,"StreamChannelMixin":1}'));
  var string$ = {
...
;
    ...
    B.List_2ZF = A._setArrayType(makeConstList(["d", "D", "\u2202", "\xce"]), type$.JSArray_String);
    ...
    B.Type_Int32_kyU = A.typeLiteral("Int32");
