        ...
        for (;;)
          switch ($async$goto) {
            ...
            case 3:
              ...
              $async$goto = reloadedSourcesPath == null ? 4 : 6;
              break;
            case 4:
              // then
              $async$result = A._setArrayType([], type$.JSArray_Map_dynamic_dynamic);
              // goto join
              $async$goto = 5;
              break;
            case 6:
            ...
            case 5:
              ...
              A.promiseToFuture(A._asJSObject(A._asJSObject(t1.dartDevEmbedder).hotRestart()), type$.nullable_Object);
