...
class Debugger {
  ...
  Future<Location?> _sourceLocation(DebuggerPausedEvent e) async {
    final frame = (e.params?['callFrames'] as List<Map<String, Object?>>?)?[0];
    final location = frame?['location'] as Map<String, Object?>?;
  ...
  String? _frameScriptId(DebuggerPausedEvent e) {
    final frame = (e.params?['callFrames'] as List<Map<String, Object?>>?)?[0];
    return (frame?['location'] as Map<String, Object?>?)?['scriptId']
        as String?;
  }
  ...
  Future<void> _pauseHandler(DebuggerPausedEvent e) async {
    ...
    if (jsBreakpointIds.isNotEmpty) {
      ...
      if (e.data is Map<String, Object?>) {
        final map = e.data as Map<String, Object?>;
        if (map['type'] == 'object') {
