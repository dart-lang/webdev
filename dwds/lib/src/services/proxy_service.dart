...
final class DartDevelopmentServiceConnectedEvent extends Event {
  DartDevelopmentServiceConnectedEvent({
    ...
    required this.uri,
           ...
           'A Dart Developer Service instance has connected and '
           'this direct connection to the VM service will now be closed. '
           'Please reconnect to the Dart Development Service at '
           '$uri.',
